from handlers.item.item_helpers.common import get_items_count_str, format_money_value, format_deposit_value, format_photos_count
from handlers.item.item_helpers.validate import short_description
...
# ─────────────────────────────────────────────────show─────────────────────────────────────────────────────────────────
def my_items_screen_text(count: int) -> str: # count = len(items)
...
def edit_item_start_text(item) -> str:
