...
from handlers.item.item_helpers.keyboard import build_create_item_categories_keyboard
from handlers.item.item_helpers.texts import create_item_category_step_text
...
# ─────────────────────────────────────────────────flow_create──────────────────────────────────────────────────────────
async def show_create_item_categories_step(callback: CallbackQuery, category_service: CategoryService) -> None: # event: CallbackQuery | Message,
    try:
...
async def send_item_confirmation_preview(
        *,
        message: Message,
        text: str,
        photos: list[str],
