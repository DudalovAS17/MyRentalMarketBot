...
def build_item_confirmation_keyboard() -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [InlineKeyboardButton(text="✅ Разместить товар", callback_data=ADMIN_PUBLISH_ITEM_CB)],
            [InlineKeyboardButton(text="❌ Отмена", callback_data=ADMIN_CANCEL_ITEM_CB)],
        ]
    )
