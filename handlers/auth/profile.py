...
from utils.callbacks import PROFILE_STATS, PROFILE_ACHIEVEMENTS, PROFILE_BACK


@auth_router.message(F.text == "👤 Профиль")
@auth_router.callback_query(F.data == PROFILE_BACK)
...
@auth_router.callback_query(F.data == PROFILE_ACHIEVEMENTS)
