...
class RegistrationCheckMiddleware(BaseMiddleware):
    """
    Middleware, проверяющее регистрацию и блокировку пользователя перед вызовом хендлеров (допуск пользователя в рабочую часть бота)
    ...
    def __init__(self, user_service: UserService, admin_ids: FrozenSet[int]):
        super().__init__()
