...
class NotificationService:
    ...
    async def notify_user(self, user_id: int | str, text: str, reply_markup: Optional[InlineKeyboardMarkup] = None) -> None:
        try:
            await self.bot.send_message(chat_id=user_id, text=text, reply_markup=reply_markup, parse_mode="HTML")
    ...
    async def notify_users(self, user_ids: Iterable[int | str], text: str, reply_markup: Optional[InlineKeyboardMarkup] = None) -> None:
